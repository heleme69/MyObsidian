# Luận Văn Chuyên Đề: Thuyết Thặng Dư, Phân Loại Cực Điểm Và Các Hệ Quả Trong Giải Tích Phức

**Tóm tắt tài liệu:**
Tài liệu này cung cấp một cái nhìn toàn diện và chặt chẽ về lý thuyết thặng dư (Residue Theory) trong giải tích phức. Nội dung bao gồm việc phân loại các điểm dị thường cô lập, định nghĩa cấu trúc chuỗi Laurent, thiết lập mối liên hệ bản chất giữa phương pháp phân tích phân thức Heaviside và thặng dư. Đặc biệt, tài liệu trình bày chứng minh chi tiết của Định lý Thặng dư Cauchy cùng các ứng dụng kinh điển trong việc tính toán các lớp tích phân thực suy rộng thông qua kỹ thuật trên mặt phẳng phức và Bổ đề Jordan.
