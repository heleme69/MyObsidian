...
> * Việc khôi phục lại phân hoạch $\{A_n\}_{n=1}^\infty$ từ $\sigma$-đại số $\mathcal{G} = \sigma(\{A_n\}_{n=1}^\infty)$ bằng phép giao vô hạn các tập hợp, là khả thi về mặt lý thuyết. Tuy nhiên, việc khôi phục này thường chỉ thực hiện được khi cấu trúc phân hoạch là **hữu hạn**.
